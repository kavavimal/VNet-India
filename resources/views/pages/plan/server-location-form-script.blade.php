                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 base-country"  id="product_id" name="product_id">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 server-location-country"  id="product_id" name="product_id">
                                    <option value="0">Select Base Country</option>
                                    @foreach(Helper::ContactCountryAll() as $country)                                    
                                        <option value="{{$country->name;}}" >{{  $country->name; }}</option>
                                    @endforeach
