<tr id="billingPrice-{{$list->id}}">
    ...
    <td>
        <button type="button" class="btn btn-outline-primary btn-sm edit-item-billing mr-1" data-id="{{$list->id}}" data-name="{{$list->billing_name}}" data-amount="{{$list->billing_amount}}" data-percentage="{{$list->billing_percentage}}" data-type="{{$list->billing_upgrade_downgrade}}" data-toggle="modal" title="Edit"><i class="nav-icon i-pen-4"></i></button>
